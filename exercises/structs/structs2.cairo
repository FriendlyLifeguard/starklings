...
fn test_your_order() {
    ...
    let mut name = order_template.name;

    let mut year = order_template.year;

    let mut made_by_phone = order_template.made_by_phone;

    let mut made_by_mobile = order_template.made_by_mobile;
    
    let mut made_by_email = order_template.made_by_email;

    let mut item_number = order_template.item_number;

    let mut count = order_template.count;
